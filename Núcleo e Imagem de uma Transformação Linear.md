## 1. Núcleo
O Núcleo de uma [transformação linear](<Transformações Lineares>) $T:\ \mathbb R^n \ xxx \mathbb R^n$ é o conjunto de vetores $v \in \mathbb R^n$ que, após aplicar $T$ neles, o vetor resultante é o vetor nulo ($T(v)=0$). 
...
>Uma das mais importantes é caso $Ker(T)=\set0$, pois isso implica que $T$ é injetora. Isso será mais explicado em [Dimensão de uma Transformação Linear](<Transformações Lineares>).
...
>$$T(x,\;y,\;z) = (0,\;0) \ xxx \begin{empheq}[left=\empheqlbrace]{align}
x - z = 0 \\
y = 0
\end{empheq}$$
>Então
...
x=z\\
y=0
\end{empheq} \ xxx (z,0,z),com\;z\in\mathbb R\;é\;solução\;única \ xxx \boxed {Ker(T)= \set{(1,0,1)}} $$
## 2. Imagem
...
1. Normalmente é usado [Gauss-Jordan](<Métodos de resolução de Sistemas Lineares>) para resolver sistema, visto que é necessário achar a condição em que o sistema é possível (condição para que o vetor pertença a imagem).
...
>Uma das mais importantes é caso $dim\ Im(T) = dim\ \mathbb W$, pois isso implica que $T$ é sobrejetora. Isso também será mais explicado em [Dimensão de uma Transformação Linear](<Transformações Lineares>).
...
>[!example] Exemplo
>1. Seja a Transformação $T: \mathbb R^3 \ xxx \mathbb R^2$ da seguinte forma: $T (x, y, z) = (x - z,\; y)$, vamos achar o $Im(T)$:
>Sabe-se que vale 
>$$T(x,\;y,\;z) = (a,\;b) \ xxx \begin{empheq}[left=\empheqlbrace]{align}
x - z = a\\
y = b
\end{empheq}\ xxx$$
>$$\ xxx
...
>---
>2. Seja a Transformação $T: \mathbb R^3 \ xxx \mathbb R^3$ da seguinte forma: $T (x, y, z) = (x - z,\; y, -x+y+z)$, vamos achar o $Im(T)$:
>Sabe-se que vale 
>$$T(x,\;y,\;z) = (a,\;b,\; c) \ xxx \begin{empheq}[left=\empheqlbrace]{align}
x - z = a\\
y = b\\
x+z = c
\end{empheq}\ xxx$$
...
>---
>3. Seja a Transformação $T: \mathbb R^3 \ xxx \mathbb R^3$ da seguinte forma: $T (x, y, z) = (x - z,\; y, x+z)$, vamos achar o $Im(T)$:
>Sabe-se que vale 
>$$T(x,\;y,\;z) = (a,\;b,\; c) \ xxx \begin{empheq}[left=\empheqlbrace]{align}
x - z = a\\
y = b\\
